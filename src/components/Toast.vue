  ...
  >
    ...
    <div class="toast-body ">
      ...
      <div class="progress mt-2" style="height: 3px;">
        <div class="progress-bar progress-bar-striped progress-bar-animated" :class="`bg-${msg.style}`" role="progressbar" aria-valuenow="75" aria-valuemin="0" aria-valuemax="100" style="width: 0%" ref="count"></div>
      </div>
    </div>
  </div>
</template>
